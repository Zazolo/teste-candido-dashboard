...
@Component({
  selector: 'app-table-medium',
  templateUrl: './table-medium.component.html',
  styleUrls: ['./table-medium.component.scss']
})
export class TableMediumComponent implements OnInit {
